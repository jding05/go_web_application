...
func getTitle(w http.ResponseWriter, r *http.Request) (string, error) {
	...
	return m[2], nil // the title is t he second subexpression
}

// store into global var for template caching
var templates = template.Must(template.ParseFiles("edit.html", "view.html"))

// http.Error() sneds a specified HTTP response code and error message
// template name is the template file name, so we must append ".html"
